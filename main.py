...
tl_admin_users = ['demian2008'] #Poner aqui los user con acceso permanente
godlist = ['demian2008'] #Poner aqui los admin 
...
async def onmessage(bot:TelegramClient,ev: NewMessage.Event,loop,ret=False):
    ...
    if username not in tl_admin_users:
        await bot.send_message(ev.chat.id,'🛑No Tiene Acceso, contactar a @demian2008🛑')
        return
    ...
    if '/start' in text:
        ...
        reply += '<a href="https://t.me/demian2008">Soporte</a>'
    ...
    if '/up' in text:
        ...
        try:
            ...
            await bot.send_file(ev.chat,txtsendname,
                                ...
                                thumb='thumb.png',
                                buttons=[Button.url('Soporte','https://t.me/demian2008')])
